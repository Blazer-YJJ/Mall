                    ...
                    <div class="item-address">
                        ...
                        <div class="addr-list clearfix">
                            <div class="addr-info" :class="{'checked':index == checkIndex}" @click="checkIndex=index" v-for="(item,index) in list" :key="index">
                                <h2>姓名：{{item.receiverName}}</h2>
                                <div class="phone">电话/手机号码：{{item.receiverMobile}}</div>
                                <div class="street">
                                    收货地址：{{item.receiverProvince + ' ' + item.receiverCity + ' ' + item.receiverDistrict + ' ' + item.receiverAddress }}
                                </div>
                                <div class="action">
