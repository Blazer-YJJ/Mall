<template>
    <div class="cart">
        <order-header title="我的购物车">
            <template v-slot:tip>
                <span>温馨提示：下单后请在三十分钟进行付款哟，否则超时会取消订单</span>
            </template>
        </order-header>
        <div class="wrapper">
                ...
                <div class="container">
                    <div class="cart-box">
                        <ul class="cart-item-head">
                            <li class="col-1">
                                <span class="checkbox" v-bind:class="{'checked':allChecked}" v-on:click="toggleAll"></span>
                                全选
                            </li>
                        ...
                        <ul class="cart-item-list">
                            <li class="cart-item" v-for="(item,index) in list" v-bind:key="index">
                                <div class="item-check">
                                    <span class="checkbox" v-bind:class="{'checked':item.productSelected}" v-on:click="updateCart(item)"></span>
                                </div>
                                <div class="item-name">
                                    <!-- v-lazy:懒加载 -->
