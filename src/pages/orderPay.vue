            ...
            <div class="container">
                <div class="order-wrap">
                    <div class="item-order">
                        ...
                        <div class="order-total">
                            ...
                            <p>订单详情<em class="icon-down" v-bind:class="{'up':showDetail}" @click="showDetail=!showDetail"></em></p>
                        </div>
                    </div>
                ...
                <div class="item-pay">
                    ...
                    <div class="pay-way">
                        ...
                        <div class="pay pay-wechat" v-bind:class="{'checked':payType==2}" v-on:click="paySubmit(2)"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            paySubmit(payType){
                if (payType == 1){
                    ...
                    this.axios.post('/pay',{
                        ...
                        .catch(() => {
                            this.$message.error('微信收款二维码生成失败，请您稍后重试~');
                        })
                    })
                }
            },
