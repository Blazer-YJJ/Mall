        ...
        <div class="wrapper">
            <div class="container clearfix">
                ...
                <div class="content">
                    ...
                    <p class="item-info">一亿像素 / 手持超级夜景 / 屏下摄像头新技术/ 骁龙888plus处理器 / 黑<br/>N代屏下指纹 / 多个专业级摄像头 / 1080P屏幕</p>
                    ...
                    <div class="item-version clearfix">
                        <h2>选择版本</h2>
                        <div class="phone fl" v-bind:class="{'checked':version==1}" @click="version=1">8GB+256GB 全网通</div>
                        <div class="phone fl" v-bind:class="{'checked':version==2}" @click="version=2">8GB+512GB 全网通</div>
                        <div class="phone fl" v-bind:class="{'checked':version==3}" @click="version=3">12GB+256GB 全网通</div>
                        <div class="phone fr" v-bind:class="{'checked':version==4}" @click="version=4">12GB+512GB 全网通</div>
                    </div>
